...
myNCell = Cells(x, "N").Value
myOCell = Cells(x, "O").Value
myPCell = Cells(x, "P").Value
myRCell = Cells(x, "R").Value
mySCell = Cells(x, "S").Value
myTCell = Cells(x, "T").Value
myUCell = Cells(x, "U").Value
myVCell = Cells(x, "V").Value
myWCell = Cells(x, "W").Value
myXCell = Cells(x, "X").Value
myYCell = Cells(x, "Y").Value


myTot = myNCell + myOCell + myPCell + myRCell + mySCell + myTCell + myUCell + myVCell + myWCell + myXCell + myYCell

Cells(x, "AB").Value = myTot
