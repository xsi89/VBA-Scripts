Attribute VB_Name = "Volvo_Penta_Import1"
Sub Change_pt_OrgFile()
'Kör detta skript för att ta bort pti
Dim ws As Worksheet
...
myLangFileN.Activate
Columns(1).Select
Selection.Copy


noLangFilen.Activate
