...
Sub LoopAllExcelFilesInFolder_THREE()
    ...
    Set rng = wsSrc.UsedRange
        For Each cl In rng.Columns
            If cl.Cells(1, 1).Value <> "" Then
                ...
                cl.Copy wbNew.Sheets(1).Range("B1")
                wbNew.CheckCompatibility = False
                
                wbNew.SaveAs ThisWorkbook.Path & "\" & myFilenoEx & "_" & cl.Cells(1, 1).Value & "_NoTrans.xls", xlExcel8
                wbNew.Close
            End If
        Next cl
End Sub
