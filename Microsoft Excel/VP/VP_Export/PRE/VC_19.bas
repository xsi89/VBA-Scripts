Attribute VB_Name = "Volvo_Penta14"
Sub clearexcept()
For Each MyCell In MyCol
    If MyCell.Column <> ActiveCell.Column Then
        MyCell.EntireColumn.Copy Worksheets("Sheet2").Cells(1, MyCell.Column)
    End If
